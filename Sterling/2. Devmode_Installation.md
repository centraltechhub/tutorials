...
-DuiExtensibilityWorkspaceDir=/home/admin/IBM/OM_950/extensions/customization Optional property for on-premise installation. This property is not required for DTK. This property will direct UI customization files to the specified directory set in property value. 
```
